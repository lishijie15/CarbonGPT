...
def test(mode, mae_thresh=None, mape_thresh=0.0):
    ...
    print(y_true_load.shape, y_pred_load.shape, y_true_pv.shape, y_pred_pv.shape, y_true_wind.shape, y_pred_wind.shape)
...
folder_path = '../result_test/CaronGPT_Encoder_7b_pv10_'
