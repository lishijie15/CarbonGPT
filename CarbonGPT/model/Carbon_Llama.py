...
from carbongpt.model.st_layers import ST_Enc, parse_args
import json
...
class STLlamaModel(LlamaModel):
    ...
    def __init__(self, config: LlamaConfig):
        ...
        if hasattr(config, "st_tower"):
            if self.config.st_tower == "Carbon_Encoder":
                args = parse_args()
    ...
    def initialize_st_modules(self, st_tower, st_select_layer,
                                 pretrain_st_mlp_adapter=None, fsdp=None):
